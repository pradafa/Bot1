...
global.sig = 'https://www.instagram.com/mdfaa04' // ig
...
global.pgopay = '-' //
global.plinkaja = '-' //
global.ppulsa = '089514653159' //tri
...
global.namebot = 'FaaBotz'
global.nameown = 'DapaMV :v'
...
/*============== WATERMARK ==============*/
global.wm = '                「 FAA-BOTZ 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘FAA-BOTZ ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ WH-MODS-BOT-V1 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By FAA BOTZ`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 DAFA MV  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'DAFA-MV'
global.stickauth = `By ©faa-botz`
